...
import com.algorand.scalgorand.builder.transaction.ApplicationBaseTransactionBuilder;
import com.algorand.scalgorand.crypto.Address;
import com.algorand.scalgorand.crypto.TEALProgram;
import com.algorand.scalgorand.logic.StateSchema;
import com.algorand.scalgorand.v2.client.algod.AccountInformation;
import com.algorand.scalgorand.v2.client.algod.TealCompile;
import com.algorand.scalgorand.v2.client.common.AlgodClient;
import com.algorand.scalgorand.v2.client.common.Response;
import com.algorand.scalgorand.v2.client.model.Application;
import com.algorand.scalgorand.v2.client.model.ApplicationLocalState;
...
import com.algorand.scalgorand.v2.client.model.TransactionsResponse;
...
public class StatefulSmartContract {
    ...
    public void readLocalState(AlgodClient client, Account account, Long appId) throws Exception {
        Response<com.algorand.scalgorand.v2.client.model.Account> acctResponse = client.AccountInformation(account.getAddress()).execute();
