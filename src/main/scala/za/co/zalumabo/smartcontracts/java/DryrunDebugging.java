...
import com.algorand.scalgorand.v2.client.model.DryrunRequest;
import com.algorand.scalgorand.v2.client.model.DryrunResponse;
import com.algorand.scalgorand.v2.client.model.DryrunSource;
import java.util.List;
import com.algorand.scalgorand.crypto.*;
...
public class DryrunDebugging {
    ...
    public void waitForConfirmation(String txID) throws Exception {
        ...
        while (true) {
            try {
                ...
                if (pendingInfo.body().confirmedRound() > 0) {
    ...
    private Response<DryrunResponse> getDryrunResponse(SignedTransaction stxn, byte[] source)
        ...
        // source
            ...
            drs.fieldName_$eq("lsig");
            drs.source_$eq(new String(source));
            drs.txnIndex_$eq(0l);
            sources.add(drs);
            stxns.add(stxn);
        }
